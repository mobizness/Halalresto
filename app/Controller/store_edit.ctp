                            ...
                            <div class="tab-pane fade" id="meat">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group" id="meat_issuer_name" style="<?php echo !empty($this->request->data['Store']['meat']) && $this->request->data['Store']['meat'] == "No" ? "display:none" : ""; ?>">
                                        <label class="col-md-3 control-label">Nom de l'émetteur de viande<span class="star">*</span></label> 
                                        <div class="col-md-6 col-lg-4"> <?php
                                                echo $form->input('meat_issuer_name',array(
                                                    'class' => 'form-control',
                                                    'type'=>'select',
                                                    'default'=> $this->request->data['Store']['meat']
                                                    'options'=>$meat_issuers,
                                                    'label' => false
                                                        ));
