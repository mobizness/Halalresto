...
class SearchesController extends AppController {
	...
	public function index() {
		...
		$this->set(compact('cityList','storeOffers'));
	}
	...
	public function stores($cityName, $cityId, $areaName, $areaId) {
		...
		if (empty($storeList)) {
			$this->Session->setFlash('<p>'.__('Le restaurant n’est pas disponible', true).'</p>', 'default', 
	...
	public function storeitems($storename, $storeId) {
		...
		$this->set(compact('storeList', 'productList', 'storeDetails', 'mainCategoryList',
					 	...
					 	'storeOffers', 'dealProducts', 'guests', 'times','ratingDetail'));
