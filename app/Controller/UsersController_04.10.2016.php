...
class UsersController extends AppController {
	...
	public $uses = array('User', 'Customer','Notification', 'Store', 'ContactUs', 'StoreTiming');
	...
	public function beforeFilter() {
		...
		$this->Auth->allow(array('signup', 'customer_customerLogin','storeLogin','storeActiveLink',
								'activeLink', 'logout', 'social_login', 'social_endpoint', 'storeSignup', 'contactUs'));
		parent::beforeFilter();
	}
    ...
    */
	...
	public function storeSignup() {
		...
		if ($this->Auth->loggedIn()) {
			echo '<h3 class="form-title"> You are not authorized to access this Page </h3>
        			<a href="'.$this->siteUrl.'/users/logout/storeregister"> Click here to Logout  </a>';
			exit();
		}
