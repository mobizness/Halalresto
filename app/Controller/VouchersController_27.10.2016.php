  ...
  public function admin_add() {
    if(!empty($this->request->data['Voucher'])) {
      ...
      if($this->Voucher->validates()) {
        ...
        if(!empty($voucher)) {
            $this->Session->setFlash('<p>'.__('Voucher code is already exists', true).'</p>', 'default', 
                                              array('class' => 'alert alert-danger'));
        } else {
            $this->request->data['Voucher']['offer_value'] = 
                                                ($this->request->data['Voucher']['offer_mode'] != 'free_delivery') ? 
