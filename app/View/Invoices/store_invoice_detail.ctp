		...
		<div class="portlet light">
			<div class="portlet-body">
				<div class="invoice">
					...
					Period :<?php
						echo $invoice_detail['Invoice']['start_date'].' to '.$invoice_detail['Invoice']['end_date']; ?>
					<hr>
					<div class="row">
						<div class="col-md-4 col-xs-12">
							<h3>Client:</h3>
							<ul class="list-unstyled">
								<li> <?php echo $invoice_detail['Store']['contact_name']; ?>
								</li>
								<li> <?php echo $invoice_detail['Store']['store_name']; ?>
								</li>
								<li><?php
					...
					<br>
					<a  onclick="PrintElem('#invoice_print')" class="btn btn-lg blue hidden-print margin-bottom-5 btn btn-info"> Print <i class="fa fa-print"></i> </a>
					<a target="_blank" href="<?php echo $siteUrl.'/Invoices/invoicePdf/'.$invoice_detail['Invoice']['id'];?>" class="btn btn-lg blue hidden-print margin-bottom-5">
						DownloadPDF <i class="fa fa-file-pdf-o"></i> </a>
											...
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody> <?php
										 			...
										 			<tr class="odd gradeX">
			                                            ...
			                                            <td><?php echo ($value['Order']['tax_amount'] != 0) ? html_entity_decode($this->Number->currency($value['Order']['tax_amount'], $siteCurrency)) : '0.00';?>
			                                            </td>
			                                            <td><?php echo ($value['Order']['delivery_charge'] != 0) ? html_entity_decode($this->Number->currency($value['Order']['delivery_charge'], $siteCurrency)) : '0.00';?>
			                                            </td>
			                                            <td><?php
			                                                $commision = $value['Order']['order_sub_total'] * ($invoice_detail['Invoice']['tax'] / 100);
...
<script type="text/javascript">
    ...
    function Popup(data) {
        ...
        mywindow.document.write('<html><head><title>Invoice</title>');
       	mywindow.document.write('<link rel="stylesheet" type="text/css" href="'+rp+'/assets/css/bootstrap.min.css" /><link rel="stylesheet" type="text/css" href="'+rp+'/assets/css/components.css" />');
