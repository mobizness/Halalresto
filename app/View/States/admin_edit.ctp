<div class="contain">
	<div class="contain">
		<h3 class="page-title">Editer Departement</h3>
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="<?php echo $siteUrl.'/admin/states/index';?>">Gestion Departement</a>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
					<a href="#">Editer Departement</a>
				</li>
			</ul>
		</div>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i> Editer Departement
							</div>
							<div class="tools">
