			...
			<div class="navbar-header">
				...
				if ($controllerName != 'checkouts') { ?>
					...
					if ($this->request->params['controller'] == 'searches' &&
						...
						<li> <a href="<?php echo $siteUrl.'/apply'; ?>"><img alt="Delivery Boy" src="<?php echo $siteUrl.'/frontend/images/deliveryboy-24-x-24.png'; ?>" title="Delivery Boy"><br> <span>Delivery Boy</span></a></li> <?php
			 ...
			 <?php
				...
				if ($controllerName != 'checkouts') { ?>
					...
					<ul class="nav navbar-nav navbar-right hidden-sm hidden-md"> <?php
						if ($this->request->params['controller'] == 'searches' &&
							$this->request->params['action'] == 'index') { ?>
							<li> <a class="delboy" href="<?php echo $siteUrl.'/apply'; ?>">delivery boy</a></li>
							<?php
						}
							if ($this->request->params['controller'] == 'searches' &&
								$this->request->params['action'] == 'storeitems') {
