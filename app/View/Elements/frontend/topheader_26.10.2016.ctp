	...
	<div class="container">
			...
			<div class="navbar-header">
				...
				if ($controllerName != 'checkouts') { ?>
					...
					if ($this->request->params['controller'] == 'searches' &&
						...
						<li> <a href="<?php echo $siteUrl.'/apply'; ?>"><img alt="Postulez maintenant" src="<?php echo $siteUrl.'/frontend/images/deliveryboy-24-x-24.png'; ?>" title="Postulez maintenant"><br> <span><?php echo __('Delivery Boy', true); ?></span></a></li> <?php
						...
						if(!empty($loggedCheck) && ($loggedCheck['role_id'] == 4)){
							...
							<li> <a href="<?php echo $siteUrl.'/customerlogin'; ?>"><img alt="Login" src="<?php echo $siteUrl.'/frontend/images/login.png'; ?>" title="Login"><br> <span> Se connecter</span></a> </li>
							<li> <a href="<?php echo $siteUrl.'/signup'; ?>"><img alt="Signup" src="<?php echo $siteUrl.'/frontend/images/signup.png'; ?>" title="Signup"><br> <span><?php echo __('Sign Up');?></span></a></li>
							<?php 
						}
			...
			<div class="collapse navbar-collapse" id="example-navbar-collapse">
			 <?php
				...
				if ($controllerName != 'checkouts') { ?>
					...
					<ul class="nav navbar-nav navbar-right hidden-sm hidden-md"> <?php
						if ($this->request->params['controller'] == 'searches' &&
							$this->request->params['action'] == 'index') { ?>
		...
		<?php if ($this->request->params['controller'] == 'searches' && $this->request->params['action'] == 'storeitems') { ?>
			...
			<div class="col-sm-12 text-center">
                ...
                if($siteSetting['Sitesetting']['address_mode'] == 'Google') { ?>
				<div class="headermenudel"><?php echo __('Distance');?> : <?php echo $storeDetails['Store']['distance']; ?> Miles</div><?php
                } ?>
