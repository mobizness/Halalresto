...
?>
 ...
 if ($this->request->params['controller'] == 'searches' && $this->request->params['action'] == 'index') {
 	...
 	<div class="header detailheader clearfix" <?php if($storeDetails['Store']['store_banner']) { ?> style="background-size: cover;background-image:url(<?php echo $siteUrl.'/storebanner/home/'.$storeDetails['Store']['store_banner']; ?>);background-repeat: no-repeat;" <?php } ?>>	 
<?php
 } else {
 	echo '<div class="header indexheader static_header">';
 } ?>
<div class="btn-cart-toggle pull-right">&nbsp;</div>
<div <?php if($this->request->params['action'] == 'storeitems') { ?>class="headerouterfix"<?php }?>>
	<div class="container">
			...
			<div class="navbar-header">
				...
				if ($controllerName != 'checkouts') { ?>
					...
					if ($this->request->params['controller'] == 'searches' &&
						...
						<li> <a href="<?php echo $siteUrl.'/apply'; ?>"><!--<img alt="Postulez maintenant" src="<?php echo $siteUrl.'/frontend/images/deliveryboy-24-x-24.png'; ?>" title="Postulez maintenant">--> <span><?php echo __('Delivery Boy', true); ?></span></a></li> <?php
		...
		<?php if ($this->request->params['controller'] == 'searches' && $this->request->params['action'] == 'storeitems') { ?>
			...
			<div class="col-sm-12 text-center">
                ...
                if($siteSetting['Sitesetting']['address_mode'] == 'Google') { ?>
				<div class="headermenudel"><?php echo __('Distance');?> : <?php echo $storeDetails['Store']['distance']; ?>km</div><?php
                } ?>
