	...
	<?php if ($this->request->params['action'] != 'storeitems') {
		...
		<footer id="footer" class="pluginFooter">
	       <div id="footer-copyright">
	          <div class="container">
	             <div class="row">
	                <div class="col-sm-6 hidden-xs clearfix text-left">
	                   ...
	                   <div class="flickr-widget widget text-left">
	                   		...
	                   		<p class="col-xs-12 no-margin-LR"><a href="<?php echo $siteUrl.'/faq'; ?>">  <?php echo __('FAQ', true); ?></a></p>
	                   		<p class="col-xs-12 no-margin-LR"><a href="<?php echo $siteUrl.'/contactUs'; ?>">  <?php echo __('Contact Us', true); ?></a></p>
	                ...
	                <div class="col-sm-6 hidden-xs clearfix text-left">
	               		<div class="flickr-widget widget">
	                		<h5>  <?php echo __('Who are we', true); ?></h5>
	                   		<p class="col-xs-12 no-margin-LR"><a href="<?php echo $siteUrl.'/aboutus'; ?>">  <?php echo __('About us', true); ?></a></p>
	                   		<p class="col-xs-12 no-margin-LR"><a href="<?php echo $siteUrl.'/cgv'; ?>">  <?php echo __('CGV', true); ?></a></p>
	                   	</div>
	                </div>

	                <div class="col-lg-6 clearfix">
	                    <div class="text-center visamargin">
	                        <a href="#"><img src="<?php echo $this->webroot; ?>frontend/images/paypal.png" height="25"></a>
	                        <a href="#"><img src="<?php echo $this->webroot; ?>frontend/images/merge.png"></a>
	                    </div>
	                </div>
	                ...
	                <div class="col-lg-12 clearfix">
	                   <p class="copyright"> 2016 &copy;
	                      <a href="<?php echo $siteUrl; ?>">  <?php echo __($siteSetting['Sitesetting']['site_name'], true); ?></a> by <?php echo $siteSetting['Sitesetting']['site_name']; ?>
