...
<html>
	...
	<?php if ($this->request->params['action'] != 'storeitems') {
		...
		<footer id="footer" class="pluginFooter">
	       <div id="footer-copyright">
	          <div class="container">
	             <div class="row">
	                <div class="col-sm-12 hidden-xs clearfix text-center">
    ...
    <script type="text/javascript">   
		...
		function searchProducts() {
			...
			if (searchKey == '') {
				$(".searchMenuForm").after("<label class='error'> <?php echo __('Please enter food name'); ?> </label>");
				$('.ui-loader').hide();
		...
		function validateAddress () {
			...
			$('.error').html('');			
			if(title == '') {
				$('.titleerorr').html("<?php echo __('Please enter title'); ?>");
