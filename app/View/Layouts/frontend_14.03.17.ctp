	             ...
	             <div class="row">
	                ...
	                <div class="col-sm-3 clearfix">
						...
						<div class="text-left visamargin">
							...
							<a class="btn btn-sm" target="_blank" href="https://www.linkedin.com/"><i class="fa fa-linkedin"></i></a>
							<a class="btn btn-sm" target="_blank" href="https://www.youtube.com/"><i class="fa fa-youtube"></i></a>
							<a class="btn btn-sm" target="_blank" href="https://accounts.google.com/"><i class="fa fa-google-plus"></i></a>
	                    </div>
