...
<html>
    <head>
        ...
        <?php
        $singleImage = array("homepageimagechange3.png", "homepageimagechange1.png", "homepageimagechange2.png");
        $indexNum = rand(0,2);
        ?>
        <style>
            .parallax {
            ...
            .single-image {
                background-image: url("../frontend/images/<?php echo $singleImage[$indexNum];?>");
        ...
        <footer id="footer" class="pluginFooter">
            <div id="footer-copyright">
                ...
                <a class="linktonew" href="www.leguideduhalal.fr">legales Le Guide du Halal</a>
                        ...
                        <div class="text-left visamargin margin-top-40">
                            <a class="btn btn-sm" target="_blank" href="https://www.facebook.com/HALAL-RESTO-174126233017569/"><img src="https://halal-resto.fr/frontend/images/ff.png"></a>
                            <a class="btn btn-sm" target="_blank" href="https://accounts.google.com/"><img src="https://halal-resto.fr/frontend/images/fg.png"></a>
                            <a class="btn btn-sm" target="_blank" href="https://www.instagram.com/halal_resto/"><img src="https://halal-resto.fr/frontend/images/fi.png"></a>
                            <a class="btn btn-sm" target="_blank" href="https://twitter.com/halal_resto"><img src="https://halal-resto.fr/frontend/images/ft.png"></a>
                            <a class="btn btn-sm" target="_blank" href="https://www.youtube.com/"><img src="https://halal-resto.fr/frontend/images/fy.png"></a>
                        </div>
                    </div>
                </div>
            </div>
...
//        });
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".nr_fg").click(function () {
                $(".nr_fg").removeClass("active");
                $(this).addClass("active");
            });
        });
    </script>
