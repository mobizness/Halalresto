<style>
    .myaccount-tabs{
        margin-top: 70px;
        border: 2px solid #3aaf53;
        border-radius: 10px;
    }
    .myaccount-tabs a{
        border: none;
        border-top: 2px solid #3aaf53;
        margin: 0;
        padding: 5px 0;
    }
    .myaccount-tabs a.active{
        background: #dcdcdc ;
    }
    .myaccount-tabs p{
        text-align: left;
        ...
        font: 500 18px/30px proximanova;
        margin-top: 10px;
        text-transform: capitalize;
        font-weight: bold;
        margin-bottom: 0;
    }
    .myaccount-tabs a div.myaccount-label{
        text-align: left;
        padding-left: 10px;
        margin: 5px 0;
    }
...
<div class="container searchshopContent">
    <div class="clearfix customerMyAccount">
        ...
        <div class="myaccount-tabs col-md-3 col-lg-3 col-sm-3 col-xs-12">
            <p>Espace client</p>
            <a class="active" href="javascript:void(0);" id="followupOrder">
                <div class="myaccount-label">Suivi De Ma Commande</div>
            </a>
            <a class="" href="javascript:void(0);" id="orderhistory">
                <div class="myaccount-label">Historique des commandes</div>
            </a>
            <a href="javascript:void(0);" id="profile" class="">
                <div class="myaccount-label">Parametres du compte</div>
            </a>
            <a href="javascript:void(0);" id="wallet" class="">
                <div class="myaccount-label"> <?php echo __('Wallet', true); ?></div>
            </a>
            <!--            <a href="javascript:void(0);" id="password_change" class="">
                            <div class="myaccount-label"> <?php echo __('Password', true); ?></div>
                        </a>-->
            <a href="javascript:void(0);" id="address">
                <div class="myaccount-label">Adresses de livraison</div>
            </a>
            <a href="javascript:void(0);" id="favourite">
                <div class="myaccount-label">Mes yummy</div>
            </a>
        </div>
        ...
        <div class="col-md-9 col-sm-9 col-xs-12"> <?php
            ...
            <div class="myorderTab" id="followupOrder_content">
                <h1> <?php echo __('Suivi De Ma Commande', true); ?></h1>				
                <div class="table-responsive">
                    <table class="table table-hover datatable-common" >
                        ...
                        <tbody>
							<?php if(!empty($follow_up_orders)) { 
		                    	foreach($follow_up_orders as $key => $value){  ?>
                            <tr>
                                <td class="order_history"> 
                                    <div class="cust_ord_history_table">
                                        <div class="col-sm-4 col-md-4 col-xs-12">
                                            ...
                                            <span  class="cust_order_history"><?php echo __('Status', true); ?>:<span id="statuss<?php echo $value['Order']['id']; ?>" class="cust_order_payment"><?php 
													echo ($value['Order']['status'] == 'Accepted') ?
														__('En cours de préparation') :  __($value['Order']['status']);?></span></span>
                                            <span  class="cust_order_history">
                                                <?php
                                                    if($value['Order']['status'] != "Pending" && strtolower($value['Order']['assoonas']) == "now"){
                                                        ?>
                                                    Temps estimé par le restaurant: <span class="cust_order_payment"><?php echo $value['Order']['estimated_pickup_time'];?> </span>       
                                                    <?php
                                                    }
                                                ?>
                                            </span>
            ...
            <div class="myorderTab" id="profile_content" style="display:none;">
                <h1 class="text-center"> <?php echo __('Profile', true); ?></h1>
                <div class="row"> <?php
	                   echo $this->Form->create('Customer', array('class' => 'login-form','type'=>'file')); ?>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="cardDetailHead text-center"> <?php echo __('Basic Details', true); ?></div> 
                                ...
                                <div class="form-group profile-box">
                                    <label class="control-label col-md-12 text-left hide"> <?php echo __('First Name', true); ?></label>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group profile-box">
                                    <label class="control-label col-md-12 text-left hide"> <?php echo __('Last Name', true); ?></label>
                                    <div class="col-md-4">
                                        <div class="formLabel"><?php
                                ...
                                <div class="form-group profile-box">
                                    <label class="control-label col-md-12 text-left hide"> <?php echo __('Phone Number', true); ?></label>
                                    <div class="col-md-4">
                                        <div class="formLabel"><?php
                    ...
                    <div class="col-md-12 col-xs-12 col-sm-12 profile-right">

                        <div class="paymentWrapper cardProfile clearfix">
                            <div class="cardDetailHead text-center"> <?php echo __('Saved Card Details'); ?>
                ...
                <div class="row">
                    ...
                    <!-- User Email Change -->
                    <div class="col-md-12 col-sm-12 col-xs-12 change_user_email text-center"> <?php echo __('Change User Email', true); ?></div><?php
				echo $this->Form->create('Customer', array('class' => 'form-horizontal col-md-12',
															'controller'=>'Customers',
															'action'=>'changeCustomerEmail',
															'onsubmit' => 'return changeCustomerEmail();' )); ?>
                    <div class="cardDetailHead text-center hide"> <?php echo __('User Email', true); ?></div>
                    <div class="form-group margin-t-25">
                        <label class="control-label col-md-3 text-left"> <?php echo __('Current User Email', true); ?></label>
                        <div class="col-md-8 user_name"><?php
							echo $this->request->data['User']['username'];  ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 text-left"> <?php echo __('New User Email', true); ?></label>
                        <div class="col-md-8 col-sm-12 col-xs-12"><?php
							echo $this->Form->input('Customer.customer_email',
								array('class'=>'form-control',
									'autocomplete' => 'off',
									'placeholder' => __('New User Email'),
									'label' => false,
									'value' => false,
									'div' => false)); ?>
				...
				echo $this->Form->end();?>
                    ...
                    <!-- Change Password -->
                    <div class="col-md-12 col-sm-12 col-xs-12 change_user_email text-center"> <?php echo __('Password', true); ?></div><?php
				echo $this->Form->create('Customer', array('class' => 'form-horizontal col-md-12','controller'=>'Customers','action'=>'changePassword')); ?>
                    <div class="cardDetailHead text-center hide"> <?php echo __('Change Password', true); ?></div>
                    <label class="error passerror"></label>
                    <div class="form-group margin-t-25">
                        <label class="control-label col-md-3 text-left"> <?php echo __('Current Password', true); ?></label>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 text-left"> <?php echo __('New Password', true); ?></label>
                        <div class="col-md-8"><?php
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 text-left"> <?php echo __('Confirm Password', true); ?></label>
                        <div class="col-md-8"><?php
                ...
                <div id="addMoney"> 
                    ...
                    <div class="row"> <?php
                        ...
                        <div class="paymentWrapper cardProfile clearfix no-padding">
                            <div class="margin-t-15 margin-b-15 wallet_price">
                                ...
                                <div class="col-sm-4 form-horizontal amount_class">
                            ...
                            <div class="teenmobilenoMar">
                                <div id="savedCards" class="col-sm-12"> <?php 
										if(!empty($Stripe_detail)) {
											foreach ($Stripe_detail as $key => $value) { ?>
            ...
            <div class="myorderTab" id="favourite_content" style="display:none;">
                <h1> <?php echo __('Mes Yummy', true); ?></h1>
                <div class="row">
                    <div class="col-sm-12">
