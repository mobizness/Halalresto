	...
	<div class="panel with-nav-tabs panel-default">
		...
		<div class="panel-body">
			<div class="tab-content">
				...
				<div class="tab-pane fade min-height" id="review">
					Review Text
					<?php var_dump($ratingDetail);?>
				</div>
				<div class="tab-pane fade min-height" id="info">
					<h1 class="text-center"><?php echo $storeDetails["Store"]["store_name"]; ?></h1>
					<h5 class="text-center"><?php echo $storeDetails["Store"]["address"]; ?></h5>
<div class="container">
	<table class="table table-stripped">
		...
		<tr>
			...
			<td><?php echo $storeDetails["StoreTiming"]["monday_firstopen_time"]; ?></td>
			<!--							<td>--><?php //echo print_r($storeDetails["StoreTiming"]); ?><!--</td>-->
			<td><?php echo $storeDetails['StoreTiming']['monday_firstclose_time']; ?></td>
		</tr>
		<tr>
			<td><?php echo $storeDetails['StoreTiming']['monday_secondopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['monday_secondclose_time'] ?></td>
		</tr>
		<!--Tuesday-->
		<tr>
			<td rowspan="2">Tuesday</td>
			<td><?php echo $storeDetails['StoreTiming']['tuesday_firstopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['tuesday_firstclose_time'] ?></td>
		</tr>
		<tr>
			<td><?php echo $storeDetails['StoreTiming']['tuesday_secondopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['tuesday_secondclose_time'] ?></td>
		</tr>
		<!--Wednesday-->
		<tr>
			<td rowspan="2">Wednesday</td>
			<td><?php echo $storeDetails['StoreTiming']['wednesday_firstopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['wednesday_firstclose_time'] ?></td>
		</tr>
		<tr>
			<td><?php echo $storeDetails['StoreTiming']['wednesday_secondopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['wednesday_secondclose_time'] ?></td>
		</tr>
		<!--Thursday-->
		<tr>
			<td rowspan="2">Monday</td>
			<td><?php echo $storeDetails['StoreTiming']['thursday_firstopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['thursday_firstclose_time'] ?></td>
		</tr>
		<tr>
			<td><?php echo $storeDetails['StoreTiming']['thursday_secondopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['thursday_secondclose_time'] ?></td>
		</tr>
		<!--Friday-->
		<tr>
			<td rowspan="2">Friday</td>
			<td><?php echo $storeDetails['StoreTiming']['friday_firstopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['friday_firstclose_time'] ?></td>
		</tr>
		<tr>
			<td><?php echo $storeDetails['StoreTiming']['friday_secondopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['friday_secondclose_time'] ?></td>
		</tr>
		<!--Saturday-->
		<tr>
			<td rowspan="2">Saturday</td>
			<td><?php echo $storeDetails['StoreTiming']['saturday_firstopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['saturday_firstclose_time'] ?></td>
		</tr>
		<tr>
			<td><?php echo $storeDetails['StoreTiming']['saturday_secondopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['saturday_secondclose_time'] ?></td>
		</tr>
		<!--Sunday-->
		<tr>
			<td rowspan="2">Sunday</td>
			<td><?php echo $storeDetails['StoreTiming']['sunday_firstopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['sunday_firstclose_time'] ?></td>
		</tr>
		<tr>
			<td><?php echo $storeDetails['StoreTiming']['sunday_secondopen_time'] ?></td>
			<td><?php echo $storeDetails['StoreTiming']['sunday_secondclose_time'] ?></td>
		</tr>
