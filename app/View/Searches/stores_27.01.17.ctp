    ...
    <div class="container">
        ...
        <div class="col-sm-12 margin-t-20" id="showFilterResult">
            ...
            if (!empty($storeList)) {
                        ...
                        <div class="searchoutertable item <?php echo $actCuisine; ?>">
                            ...
                            <div class="col-sm-6 padding-t-15 padding-b-15">
                                ...
                                <div class="col-sm-9 no-padding">
                                    ...
                                    <div class="<?php echo ($value['Store']['status'] == 'Order') ? 'btn btn-primary btn_mar_left' : 'btn btn-info btn_red_color btn_mar_left'; ?>">
                                <span> <?php
                                    ...
                                    if ($siteSetting['Sitesetting']['address_mode'] == 'Google') { ?>
                                        <div class=" col-sm-3 text-center celltable">
                                            ...
                                            <div class="distance"><?php
                                                echo (!empty($value['Store']['distance'])) ? $value['Store']['distance']: '0.00' ?>km</div>
                                        </div> <?php
                                    } ?>
                                </div>
                            </div>
                ...
                <div align="center" class="alert alert-danger col-xs-12">Pas de restaurant disponible à cette adresse</div> <?php
            } ?>
            </div>
        </div>
    </div>
