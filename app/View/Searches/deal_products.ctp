                        ...
                        <div class="product__detail_inner">
                            ...
                            <div class="bottom-section cell-table col-sm-12 col-md-3">
                                <span class="price product__detail-price">
                                    <?php echo(number_format((float)$value['MainProduct']['ProductDetail'][0]['orginal_price'],2, '.', '') . "&euro;");?>
                                </span>
                                <div class="product__detail-action">
                                    <a href="javascript:void(0);" rel="nofollow" class="button add_to_cart_button"> 
                                        ...
                                        <div class="add_btn">
                                            <i onclick="addToCart(<?php echo $value['MainProduct']['ProductDetail'][0]['id'].','.$key; ?>);" class="fa fa-plus green">
                                            </i>
                                        </div> <?php
                                            } else { ?>
