                                    ...
                                    <a href="javascript:void(0);" rel="nofollow" class="button add_to_cart_button"> <?php
                                        ...
                                        <div class="add_btn">
                                            <i onclick="addToCart(<?php echo $value['MainProduct']['ProductDetail'][0]['id'].','.$key; ?>);"
                                               class="fa fa-plus green"></i></div> <?php
                                                } else { ?>
                                        <div class="add_btn"><i
...
<div class="products-category mainCatProduct" id="<?php echo $value['MainCategory']['category_name']; ?>">
    ...
    <ul class="products productsCat<?php echo $count; ?>"> <?php
        ...
        <li class="product searchresulttoshow searchresulttoshow<?php echo $count; ?>">
            <div class="product_carts">
                <figure  class="product__image col-xs-3" onclick="productDetails(<?php echo $value['Product']['id']; ?>);">
                ...
                <div class="product__detail col-xs-9">
                    <div class="product__detail_inner">
                        ...
                        <div class="bottom-section cell-table col-sm-12 col-md-3">
                            <span class="price product__detail-price"> <?php
                                   echo  number_format((float)$value['ProductDetail'][0]['orginal_price'],2, '.', '') . "&euro;";
?>
                            </span>
                            <div class="product__detail-action">
                                <a href="javascript:void(0);" rel="nofollow" class="button add_to_cart_button "> <?php 
                                    ...
                                    <div class="add_btn">
                                        <i onclick="addToCart(<?php echo $value['ProductDetail'][0]['id'].','.$value['ProductDetail'][0]['id']; ?>);" class="fa fa-plus green"></i>
                                    </div> <?php
                                            } else { ?>
                                    <div class="add_btn"><i onclick="productDetails(<?php echo $value['Product']['id']; ?>);" class="fa fa-plus green"></i></div> <?php
                                            } ?>
                                </a>
                            </div>
                        </div>
