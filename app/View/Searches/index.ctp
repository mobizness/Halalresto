...
<div class="container indexBnner bannerrelative parallax">
            ...
            <div class="col-lg-8 col-md-10 col-lg-offset-2 col-md-offset-1 col-sm-12 middleForm">	
                ...
                <div class="alredyaccount">Already Account ? <a href="<?php echo $siteUrl.'/customerlogin'; ?>">Sign In</a></div>
					...
					<?php
					 ...
					 ?>
            <div class="col-lg-9 col-md-10 col-lg-offset-2 col-md-offset-1 col-sm-12 middleForm">	
                ...
                <div class="main-search-form-wrapper">
                   <?php echo $this->Form->create('Search', array('class' => 'shop-form',
								 'id' => 'SearchSearchByAddressForm',
                                                                'onsubmit'=>'return searchFormValidation()'
                                                                //'controller' => 'searches',
                    ...
                    <div class="form-holder">
                        <div class="row gap-0">
                            <div class="col-xs-12 col-sm-6">
                                <input class="form-control" id="searchName" name="data[Search][name]" placeholder="Trouver par nom de restaurant" type="text">
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <input class="form-control" onfocus="initialize(this.id)"  id="searchAddress" name="data[Search][address]" placeholder="Ou entrez une adresse" type="text">
                                <input name="post_type" value="listings" type="hidden">
                            </div>
                        </div>
                    </div>
                    <div class="btn-holder">
                        <input value="Trouver des restaurants" class="btn" type="submit">
                    </div>
                    <?php echo $this->Form->end(); ?>

                </div>
                <div id="searchError"class="form-error" style="display:none">Entrez le nom du restaurant / lieu</div>
                <div class="alredyaccount">Already Account ? <a href="<?php echo $siteUrl.'/customerlogin'; ?>">Sign In</a></div>
            </div> <?php
				}

			 ?>
            <div class="center store-images hidden-xs">
                <a href="#" ><img src="frontend/images/playstore.png"></a>
                <a href="#" ><img src="frontend/images/itunes.png"></a>
            </div>
...
<div class="hiw_section hidden-xs" id="hiw_section">
    <div class="container">
        ...
        <div class="row panels">
            <div class="col-sm-3 col-xs-12 col-md-3 panel-item">
...
<div class="hidden-xs">
    <div class="single-image parallax">
    </div>
</div>
...
<div class="hiw_section hidden-xs">
    <div class="container">
        <h2>  
				<?php echo __('Why Choose Us?', true); ?>
        </h2>

        <div class="row panels">
            <div class="col-sm-4 col-xs-12 col-md-4 panel-item">
                <div class="panel panel-image">
                    <div class="panel-icon whyusicon">
                        <img alt="" title="" src="<?php echo $siteUrl.'/frontend/images/image1.png'; ?>">
                    </div>
                    <div>
                        <p><?php echo __('Pour commander dans les meilleurs restaurants halal de la region', true); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 col-xs-12 col-md-4 panel-item">
                <div class="panel panel-image">
                    <div class="panel-icon whyusicon">
                        <img alt="" title="" src="<?php echo $siteUrl.'/frontend/images/image2.png'; ?>">
                    </div>
                    <p>  <?php echo __('Pour organiser vos sortis en famille en toute simplicite', true); ?></p>
                </div>
            </div>
            <div class="col-sm-4 col-xs-12 col-md-4 panel-item">
                <div class="panel panel-image">
                    <div class="panel-icon whyusicon">
                        <img alt="" title="" src="<?php echo $siteUrl.'/frontend/images/image3.png'; ?>">
                    </div>
                    <p>  <?php echo htmlspecialchars_decode(__('To stay at home and get delivered', true)); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="hidden-xs">
    <div class="double-image first-image"></div>
    <div class="double-image second-image"></div>
</div>


<?php if(sizeof($featured_stores) >= 1 && sizeof($featured_stores) <=6 ){?>
<div class="hiw_section hidden-xs">
    <div class="container">
        <h2>Découvrez de nouveaux restaurants et réservez maintenant </h2>

        <div class="row panels">
            <?php for($i=0; $i<sizeof($featured_stores); $i++){?>
            <a href="<?php echo $siteUrl.'/shop/'.$featured_stores[$i]['Store']['seo_url'].'/'.base64_encode($featured_stores[$i]['Store']['id']); ?>">
                <div class="col-sm-2 col-xs-12 col-md-2 panel-item">
                    <div class="panel panel-image">
                        <div class="panel-icon whyusicon">
                            <img style="width: 100%;" alt="" title="" src="/storelogos/<?php echo $featured_stores[$i]["Store"]["store_logo"];?>">
                        </div>
                        <p><?php echo $featured_stores[$i]["Store"]["store_name"]?></p>
                    </div>
                </div>
            </a>
            <?php }?>
...
<?php if(sizeof($featured_stores) >=6 ){
...
<div class="hiw_section hidden-xs">
    <div class="container">
        ...
        <div class="row panels">
            ...
            <a href="<?php echo $siteUrl.'/shop/'.$featured_stores[$value]['Store']['seo_url'].'/'.base64_encode($featured_stores[$value]['Store']['id']); ?>"><div class="col-sm-2 col-xs-12 col-md-2 panel-item">
                    <div class="panel panel-image">
                        <div class="panel-icon whyusicon">
                            <img style="width: 100%;" alt="" title="" src="/storelogos/<?php echo $featured_stores[$value]["Store"]["store_logo"];?>">
                        </div>
                        <p><?php echo $featured_stores[$value]["Store"]["store_name"]?></p>
                    </div>
                </div></a>
            <?php }?>
        </div>
...
<div class="foodbanner hidden-xs">
    <div class="container">
        <div class="row">
            <div class="col-sm-5">
                <h1><?php echo __('Online Ordering for your customers', true); ?></h1>
                <div class="homepage_video">
                    <iframe width="100%" height="258" src="<?php echo $homepage_youtube_link; ?>?rel=0&version=3&autoplay=1&loop=1&playlist=kJQz3eFFm6I&amp;controls=0" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
...
<section class="section-full-width">
    <div class="row gallery-full-width">
        <div class="col-sm-4 col-md-3">
            <div class="gallery-inner-item view">
                <img src="/frontend/images/g1.jpg">
                <div class="mask">
                    <div class="mask-bordered">
                        <h2 class="project-actions align-middle">
                            Pizza
                        </h2>
                    </div>
                </div>
        ...
        <div class="col-sm-4 col-md-3">
            <div class="gallery-inner-item view">
                <img src="/frontend/images/g2.jpg" style="height:100%;">
                <div class="mask">
                    <div class="mask-bordered">
                        <h2 class="project-actions align-middle">
                            Fast food
        ...
        <div class="col-sm-4 col-md-3">
            <div class="gallery-inner-item view">
                <img src="/frontend/images/g3.jpg">
                <div class="mask">
                    <div class="mask-bordered">
                        <h2 class="project-actions align-middle">
                            Sushi
        ...
        <div class="col-sm-4 col-md-3">
            <div class="gallery-inner-item view">
                <img src="/frontend/images/g4.jpg">
                <div class="mask">
                    <div class="mask-bordered">
                        <h2 class="project-actions align-middle">
                            Burger chic
        ...
        <div class="col-sm-4 col-md-3">
            <div class="gallery-inner-item view">
                <img src="/frontend/images/g5.jpg">
                <div class="mask">
                    <div class="mask-bordered">
                        <h2 class="project-actions align-middle">
                            Africain
        ...
        <div class="col-sm-4 col-md-3">
            <div class="gallery-inner-item view">
                <img src="/frontend/images/g6.jpg">
                <div class="mask">
                    <div class="mask-bordered">
                        <h2 class="project-actions align-middle">
                            Gastronomie
        ...
        <div class="col-sm-4 col-md-3">
            <div class="gallery-inner-item view">
                <img src="/frontend/images/g7.jpg">
                <div class="mask">
                    <div class="mask-bordered">
                        <h2 class="project-actions align-middle">
                            Indien
        ...
        <div class="col-sm-4 col-md-3">
            <div class="gallery-inner-item view">
                <img src="/frontend/images/g8.jpg" style="height:100%;">
                <div class="mask">
                    <div class="mask-bordered">
                        <h2 class="project-actions align-middle">
                            Thai
...
<div class="newsletter expandsignup hidden-xs">
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-5">
                <h5>Restez connectés avec Halal Resto</h5>
                <p>Abonnez-vous à notre Newsletter pour recevoir les dernières actualités Halal Resto</p>
            </div>
            <div class="col-lg-offet-2 col-md-offset-2 col-lg-5 col-md-5">
                <div class="input-group newsletters">
                    <input name="email" id="newsletterEmail" class="form-control newsletteremail" placeholder="Votre adresse email" type="text">
                    <span class="input-group-btn">
                        <button id="newsletterSubmit" class="btn btn-primary">Souscrire</button>
                    </span>
                </div>
            </div>
        </div>
...
<button style="display:none" type="button" id="newslettermessage" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Open Modal</button>
...
<div id="myModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color: #285a41 !important">
