<div class="contain">
    <div class="contain">
        <h3 class="page-title">Facturation coursier</h3>
        <div class="page-bar">
            ...
            <div class="col-md-12">
                <div class="portlet box grey-cascade">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-globe"></i> Facturation coursier
                        </div>
                        <div class="tools">
                            ...
                            <div class="table-toolbar">
                                <div class="contain">
                                    <div class="pull-right text-right">
                                        <label class="control-label pull-left">Période<span class="star">*</span></label>
                                        <div class="pull-left">
