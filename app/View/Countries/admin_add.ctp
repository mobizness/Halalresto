<div class="contain">
	<div class="contain">
		<h3 class="page-title">Ajouter Pays</h3>
		<div class="page-bar">
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i> Ajouter Pays
							</div>
							<div class="tools">
								...
								echo $this->Form->create('Country',array('class'=>"form-horizontal"));
									...
									<div class="form-body">
										<div class="form-group">
											<label class="col-md-3 control-label">Nom Pays <span class="star">*</span></label>
