                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form sitePaddinner">
                        <ul class="nav nav-tabs">
                            ...
                            <!--<li><a href="#delivery" data-toggle="tab" onclick="//return showMap();">Commande minimum</a></li>-->
                            <li><a href="#order" data-toggle="tab">Info commande</a></li>
                            <li><a href="#meat" data-toggle="tab">Information sur la viande</a></li>
                        ...
                        <div class="tab-content"> 
                            <div class="tab-pane fade active in" id="contact">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Nom du contact <span class="star">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Contact Numéro <span class="star">*</span></label>
                                        <div class="col-md-6 col-lg-4"> <?php
                            ...
                            <div class="tab-pane fade" id="meat">
                                <label id="meatError" class="error"></label>
                                <div class="form-body">

                                    <div class="form-group profile-box clearfix">
                                        <label class="control-label col-lg-3 col-md-4 col-sm-5">Avez-vous une viande certifiée?<span class="star">*</span></label>
                                        <div class="col-lg-5 col-md-6 col-sm-6">
                                            <div class="radio-list">
                                                <label class="radio-inline"> <?php 
                                                    $option1 = array('Yes'  => 'Oui');
                                                        $option2 = array('No'   => 'Non');
                                                        echo $this->Form->radio('meat',$option1,
                                                                                                array('checked'=>$option1,
                                                                                                        'label'=>false,
                                                                                                        'legend'=>false,    
                                                                                                        'checked' =>true,
                                                                                                        'class' => array('meat_radio'),
                                                                                                        'hiddenField'=>false)); ?>
                                                </label>
                                                <label class="radio-inline"><?php
                                                    echo $this->Form->radio('meat',$option2,
                                                                                            array('checked'=>$option2,
                                                                                                    'label'=>false,
                                                                                                     'class' => array('meat_radio'),
                                                                                                    'legend'=>false,
                                    ...
                                    <div class="form-group" id="meat_image" style="<?php echo !empty($this->request->data['Store']['meat']) && $this->request->data['Store']['meat'] == "No" ? "display:none" : ""; ?>">
                                        <label class="col-md-3 control-label">Image de certificat de viande<span class="star">*</span></label> 
                                        <div class="col-md-6 col-lg-4"> <?php
                                                        echo $this->Form->input('meat_certificate',
                                                                    array('type'  => 'file',
                                                                           'div'  => false,
                                                                          'label' => false
                                                                        ));
                                                            echo $this->Form->input('org_meat_certificate',
                                                            array('class' => 'form-control',
                                                                  'type' => 'hidden',
                                                                  'label' => false,
                                                                  'value' => $this->request->data['Store']['meat_certificate'])); ?>                                   
                                            <img onerror="this.onerror=null;this.src='<?php echo $siteUrl."/img/no-imge.jpg"; ?>'" class="img-responsive img_fields" src="<?php echo $siteUrl. '/storemeatcertificates/'.$this->request->data['Store']['meat_certificate']; ?>" alt="">
                                        </div>
                                    </div>

                                    <div class="form-group" id="meat_issuer_name" style="<?php echo !empty($this->request->data['Store']['meat']) && $this->request->data['Store']['meat'] == "No" ? "display:none" : ""; ?>">
                                        <label class="col-md-3 control-label">Entrez le nom du Certificateur<span class="star">*</span></label> 
                                        <div class="col-md-6 col-lg-4"> <?php
                                               echo $this->Form->input('meat_issuer_name',
                                                array('type'=>'select',
                                                                'class'=>'form-control',
                                                                'options'=> array($meat_issuers),
                                                                'label'=> false));
                                    ...
                                    <div class="form-group" id="meat_issuer_name_other" style="<?php echo !empty($this->request->data['Store']['meat']) && $this->request->data['Store']['meat'] == "No" ? "display:none" : ""; ?>">
                                        <label class="col-md-3 control-label">Entrez le nom de l'émetteur du certificat<span class="star">*</span></label> 
                                        <div class="col-md-6 col-lg-4"> <?php
                                              echo $this->Form->input('meat_issuer_name_other',
                                                        array('class' => 'form-control',
                                                                        'type'  => 'text',
                                                                        'label' => false)); ?>   
                                        </div>
                                    ...
                                    <div class="form-group" id="meat-description" style="<?php echo empty($this->request->data['Store']['meat']) || $this->request->data['Store']['meat'] == "Yes" ? "display:none" : ""; ?>">
                                        <label class="col-md-3 control-label">Description de l'endroit où vous obtenez votre viande<span class="star">*</span></label>
                                        <div class="col-md-6 col-lg-4"> <?php
                                        echo $this->Form->input('meat_description',
                                                    array('class' => 'form-control',
                                                          'type'  => 'textarea',
                                                          'label' => false)); ?>
                                        </div>
