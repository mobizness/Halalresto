                    ...
                    <div class="portlet-body form"><?php 
                        ...
                        <div class="form-body">
                                ...
                                <div class="col-md-6 col-lg-4"><?php
                                         echo $this->Form->input("HalalProduct.image", 
                                         				array("label"=>false,           
				                                                "type"=>"file",
				                                                "name"=>"data[image]")); ?>
                                    <img class="img-responsive img_fields" src="<?php echo $siteUrl. '/halalrestoproducts/original/'.$this->request->data['HalalProduct']['image']; ?>" alt="">
                            ...
                            <div style="display:none;">
                                <?php
                                echo $this->Form->input('HalalProduct.id',
		                                array("label"=>false,           
                                                "type"=>"text"
                                                )); ?>
                            </div>
