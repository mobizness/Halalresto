<div class="contain">
	<div class="contain">
			<h3 class="page-title">Code postal</h3>
			<div class="page-bar">
				...
				<div class="col-md-12">
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-globe"></i>Gestion Code postal
							</div>
							<div class="tools">
							...
							<table class="table table-striped table-bordered table-hover checktable" id="sample_12">
								...
								<tbody><?php
									...
									<tr class="odd gradeX" id="record<?php echo $value['Location']['id'];?>">
										...
										<td><?php echo date("Y/m/d H:i:s", strtotime($value['Location']['updated']));?></td>
										<td align="center"> <?php 
