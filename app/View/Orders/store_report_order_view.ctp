										...
										if(!empty($orders_list)){
											...
											foreach($orders_list['ShoppingCart'] as $key => $value) { ?>
												<tr>
													...
													<td class="price"><?php
														echo html_entity_decode($this->Number->currency($value['product_total_price'], $siteCurrency)); ?> </td>
												</tr><?php $count++;
											} ?>
											<tr>
											...
											if ($orders_list['Order']['delivery_charge'] != 0 || 
													$orders_list['Order']['voucher_code'] != '' &&
													$orders_list['Order']['voucher_amount'] == 0) { ?>
												<tr>
