                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover checktable sample_12" id="">
                            ...
                            <tbody><?php
                                ...
                                $blink_me = "";
                                $date = date("Y-m-d");
                                if($value['Order']['delivery_date'] == $date){
                                     $blink_me = "blink_me";
                                }
                                ?>
                                <tr id="orderList_<?php echo $value['Order']['id']; ?>" class="odd gradeX <?php echo $blink_me; ?>">
                                    <td><?php echo $count ;
                        ...
                        <table class="table table-striped table-bordered table-hover checktable sample_12">
                            ...
                            foreach($order_lists as $key => $value) { ?>
                                ...
                                <tr id="orderList_<?php echo $value['Order']['id']; ?>" class="odd gradeX <?php echo $blink_me;?>">
                                    ...
                                    <td align="center"> <?php
                                    $orderStatusFunction = "orderStatus(".$value['Order']['id'].");";
                                    if(strtolower($value['Order']['assoonas']) == "now"){
                                        $orderStatusFunction = "orderStatusAsap(".$value['Order']['id'].");";
                                   }
                                    echo $this->Form->input('orderStatus_'.$value['Order']['id'],
                                        array('type'=>'select',
                                            'class'=>'form-control',
                                    ...
                                    ?>
                                        ...
                                        <div id="reason_<?php echo $value['Order']['id']; ?>"></div>
                                    </td>
