...
<div class="page-content-wrapper">
    <div class="page-content">
        <h3 class="page-title">Modifier Ville de livraison</h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo $siteUrl.'/store/Categories/index';?>">Modifier Ville de livraison</a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <a href="#">Modifier Ville de livraison</a>
                </li>
            </ul>
        </div>
            ...
            <div class="col-md-12">
                <div class="portlet box blue-hoki">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-user"></i>Modifier Ville de livraison
                        </div>
                        <div class="tools"></div>
                    </div>
...
//														  'onfocus' =>'initialize(this.id)')); ?>
                        ...
                        <div style="display:none;">
                            <input type="text" value="<?php echo $store_id;?>" name="data[DeliveryLocation][store_id]"/>
                        </div>
                        <div style="display:none;">
                            <input type="text" value="<?php echo $delivery_id;?>" name="data[DeliveryLocation][id]"/>
                        </div>
