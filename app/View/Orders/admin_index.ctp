	...
	<div class="contain">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li><a href="javascript:void(0);">Gestion commande</a></li>
			</ul>
		</div>
			...
			<div class="col-md-12">
				<div class="portlet box grey-cascade">
					...
					<div class="portlet-body">
						...
						<table class="table table-striped table-bordered table-hover checktable" class="sample_12">
							<thead>
								<tr>
							...
							<tbody><?php 
                                ...
                                foreach($order_list as $key => $value) { ?>
									<tr id="orderList_<?php echo $value['Order']['id']; ?>" class="odd gradeX">
										...
										<td id="statusOrder_<?php echo $value['Order']['id']; ?>" align="center"> <?php
										...
										<td align="center"><?php
	                                        ...
	                                        onclick="deleteOrder(<?php echo $value['Order']['id'];?>);" >
