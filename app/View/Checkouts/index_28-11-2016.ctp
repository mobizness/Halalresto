				...
				<div class="panel panel-default">
					<div class="panel-body addressBg">
						<div class="panel-subheading">
							...
							<div class="paymentWrapper clearfix col-xs-5 cartlistcheck">
								...
								<ul class="itemtoplist">
									...
									<li class="item_pricetot col-xs-2"><?php echo __('Total Price', true); ?></li>
								</ul>
								<ul>
									<?php
									foreach ($shopCart as $key => $value) {										
										$storeSubtotal	+= $value['ShoppingCart']['product_total_price']; ?>										
											...
											<li class="item_name col-xs-4"><span class="menu_name"><?php echo $value['ShoppingCart']['product_name']; ?></span>
											...
											<li class="item_pricetot col-xs-2"><?php echo html_entity_decode($this->Number->currency($value['ShoppingCart']['product_total_price'], $siteCurrency)); ?></li>
										 <?php
									} ?>
								</ul>

								<ul class="">
									<li class="col-xs-5 no-padding  text-right"><?php echo __('Sub Total', true); ?></li>
									<li class="col-xs-5 no-padding  text-right"><?php echo html_entity_decode($this->Number->currency($storeSubtotal, $siteCurrency)); ?></li>
								</ul> <?php
								if (isset($offerDetails['storeOffer']) && $offerDetails['storeOffer'] != 0) { ?>
									<ul class="itemtoplist">
										<li class="col-xs-5 no-padding text-right"><?php echo __('Offer'); ?> (<?php echo $offerDetails['offerPercentage'].'%'; ?>) </li>
										<li class="col-xs-5 no-padding text-right"><?php
								...
								if (isset($taxDetails['tax']) && $taxDetails['tax'] != 0) { ?>
									<ul class="itemtoplist">
										<li class="col-xs-5 no-padding text-right"><?php echo __('Tax'); ?> (<?php echo $taxDetails['tax'].'%'; ?>)</li>
										<li class="col-xs-5 no-padding text-right"><?php
											if (isset($taxDetails['tax']) && $taxDetails['tax'] != 0) {												
			                    ...
			                    if (isset($taxDetails['deliveryCharge']) && $taxDetails['deliveryCharge'] != 0) { ?>
			                        ...
			                        <ul class="itemtoplist">
										<li class="col-xs-5 no-padding text-right"><?php echo __('Delivery Charge'); ?></li>
										<li class="col-xs-5 no-padding text-right"><?php
			                                if (isset($taxDetails['deliveryCharge']) && $taxDetails['deliveryCharge'] != 0) {
			                    ...
			                    <div class="voucherShow_<?php echo $storeMain ?>" style="display: none">
	                    			<ul class="itemtoplist">
										<li class="col-xs-5 no-padding text-right"><?php echo __('Promo Discount', true); ?></li>
										<li class="col-xs-5 no-padding text-right"><?php echo $siteCurrency.' '; ?>
								...
								<ul class="itemtoplist">
									<li class="col-xs-5 no-padding text-right"> <?php echo __('Total', true); ?></li>
									<li class="col-xs-5 no-padding text-right"> <?php 
										echo $siteCurrency.' '; ?>
			                    ...
			                    if (isset($taxDetails['tipPercentage']) && $taxDetails['tipPercentage'] != 0) { ?>
			                        <ul class="itemtoplist">
			                            <li class="col-xs-5 no-padding text-right"> Pourboire </li>
			                            <li class="col-xs-5 no-padding text-right"> <?php
	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-body"> <?php
				...
				<div class="form-group clearfix">						
					<div class="col-md-8 col-md-offset-4 paymentInfo">
						<input type="checkbox" class="savecard"> Save this card for Checkout 
					</div>
				</div>
